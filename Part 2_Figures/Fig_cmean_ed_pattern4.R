...
pdf(paste0("cmean_",corr,"_",name,"_",I,naive,".pdf"), width=10, 
    height=10.5, paper="special")

#Read in data

ICC_1 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_50_1.csv"), header=T)
ICC_2 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_300_1.csv"), header=T)
ICC_3 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_50_2.csv"), header=T)
ICC_4 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_300_2.csv"), header=T)
ICC_5 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_50_3.csv"), header=T)
ICC_6 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_300_3.csv"), header=T)
...
iccplot <- function(table,
  ...
  ggplot(table, aes(
    ...
    labs(
      title = bquote(
        bar(n) * " = " * .(cmean) * ", CV =" * .(CV) * ", Working correlation = ED"
      ),
...
p1 <- iccplot(ICC_1, cmean = cmean[1], CV = CV[1])
p2 <- iccplot(ICC_2, cmean = cmean[2], CV = CV[1])
p3 <- iccplot(ICC_3, cmean = cmean[1], CV = CV[2])
p4 <- iccplot(ICC_4, cmean = cmean[2], CV = CV[2])
p5 <- iccplot(ICC_5, cmean = cmean[1], CV = CV[3])
p6 <- iccplot(ICC_6, cmean = cmean[2], CV = CV[3])
...
ICC_1 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_50_1_naive.csv"), header=T)
ICC_2 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_300_1_naive.csv"), header=T)
ICC_3 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_50_2_naive.csv"), header=T)
ICC_4 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_300_2_naive.csv"), header=T)
ICC_5 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_50_3_naive.csv"), header=T)
ICC_6 <- read.csv(paste0(dir,"/icc_table_", corr, "_", case, I, 
                         "_300_3_naive.csv"), header=T)
