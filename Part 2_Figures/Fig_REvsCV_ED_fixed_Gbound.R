...
pdf("REvsCV_ED_fixed_1_Gbound.pdf", width=10, height=7, 
    paper="special")

#CV vs RE

REvsCV1 <- read.csv(paste0(dir, "/REvsCV.exp_1.1.csv"), header = T)
REvsCV2 <- read.csv(paste0(dir, "/REvsCV.exp_1.4.csv"), header = T)
REvsCV1.naive <-
  read.csv(paste0(dir, "/REvsCV.exp.naive_1.1.csv"), header = T)
REvsCV2.naive <-
  read.csv(paste0(dir, "/REvsCV.exp.naive_1.4.csv"), header = T)
...
#+ stat_function(fun = ~ 1/(1+(.x)^2), linetype=2, col="grey")
...
p1 <- RECV.plot1(REvsCV1, I = I[1], rho = c(0.1, 0.5, 1))
p2 <- RECV.plot1(REvsCV2, I = I[4], rho = c(0.1, 0.5, 1))

p3 <- RECV.plot2(REvsCV1.naive, I = I[1], rho = c(0.1, 0.5, 1))
p4 <- RECV.plot2(REvsCV2.naive, I = I[4], rho = c(0.1, 0.5, 1))
...
setwd("C:\\Users\\ASUS\\Desktop\\YCAS\\Figures")
pdf("REvsCV_ED_fixed_2_Gbound.pdf", width=10, height=7, 
    paper="special")

#CV vs RE


REvsCV1 <- read.csv(paste0(dir, "/REvsCV.exp_1.2.csv"), header = T)
REvsCV2 <- read.csv(paste0(dir, "/REvsCV.exp_1.3.csv"), header = T)
REvsCV1.naive <-
  read.csv(paste0(dir, "/REvsCV.exp.naive_1.2.csv"), header = T)
REvsCV2.naive <-
  read.csv(paste0(dir, "/REvsCV.exp.naive_1.3.csv"), header = T)
