...
pdf("ICC_nex_pattern4_1.pdf", width=10, height=10.5, paper="special")

#Read in data


ICC_1 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_12_1.csv"), header = T)
ICC_2 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_96_1.csv"), header = T)
ICC_3 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_12_2.csv"), header = T)
ICC_4 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_96_2.csv"), header = T)
ICC_5 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_12_3.csv"), header = T)
ICC_6 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_96_3.csv"), header = T)
...
setwd("C:\\Users\\ASUS\\Desktop\\YCAS\\Figures")
pdf("ICC_nex_pattern4_1_naive.pdf", width=10, height=10.5, paper="special")

#Read in data

ICC_1 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_12_1_naive.csv"),
           header = T)
ICC_2 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_96_1_naive.csv"),
           header = T)
ICC_3 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_12_2_naive.csv"),
           header = T)
ICC_4 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_96_2_naive.csv"),
           header = T)
ICC_5 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_12_3_naive.csv"),
           header = T)
ICC_6 <-
  read.csv(paste0(dir, "/icc_table_nex_pattern4_96_3_naive.csv"),
           header = T)
