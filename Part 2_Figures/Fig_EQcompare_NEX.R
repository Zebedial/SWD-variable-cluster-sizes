...
pdf("EQcompare_NEX.pdf", width=10, height=13.5, paper="special")

#Read in data

ICC_1 <-
  read.csv(paste0(dir, "/EQcompare_nex_12_5_100.csv"), header = T)
ICC_2 <-
  read.csv(paste0(dir, "/EQcompare_nex_96_5_100.csv"), header = T)
ICC_3 <-
  read.csv(paste0(dir, "/EQcompare_nex_12_13_100.csv"), header = T)
ICC_4 <-
  read.csv(paste0(dir, "/EQcompare_nex_96_13_100.csv"), header = T)
ICC_5 <-
  read.csv(paste0(dir, "/EQcompare_nex_12_5_300.csv"), header = T)
ICC_6 <-
  read.csv(paste0(dir, "/EQcompare_nex_96_5_300.csv"), header = T)
