...
###################################################
## Data used to produce Table 4 in the main article
###################################################

icc_table_12_1 <- icc_nex_fixed(I=12, CV=0.25, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=1)

write.csv(icc_table_12_1, file = paste0("./icc_table_nex_12_1.csv"))

icc_table_12_2 <- icc_nex_fixed(I=12, CV=0.75, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=1)

write.csv(icc_table_12_2, file = paste0("./icc_table_nex_12_2.csv"))

icc_table_12_3 <- icc_nex_fixed(I=12, CV=1.25, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=1)

write.csv(icc_table_12_3, file = paste0("./icc_table_nex_12_3.csv"))


icc_table_96_1 <- icc_nex_fixed(I=96, CV=0.25, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=1)

write.csv(icc_table_96_1, file = paste0("./icc_table_nex_96_1.csv"))

icc_table_96_2 <- icc_nex_fixed(I=96, CV=0.75, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=1)

write.csv(icc_table_96_2, file = paste0("./icc_table_nex_96_2.csv"))

icc_table_96_3 <- icc_nex_fixed(I=96, CV=1.25, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=1)

write.csv(icc_table_96_3, file = paste0("./icc_table_nex_96_3.csv"))

###################################################
## Data used to produce Table 5 in the main article
###################################################

icc_table_12_1 <- icc_nex_fixed(I=12, CV=0.25, t=5, cmean=100, delta=log(0.35),
                                base=0.3, end=0.3, type=2)

write.csv(icc_table_12_1, file = paste0("./icc_table_nex_12_1_naive.csv"))

icc_table_12_2 <- icc_nex_fixed(I=12, CV=0.75, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=2)

write.csv(icc_table_12_2, file = paste0("./icc_table_nex_12_2_naive.csv"))

icc_table_12_3 <- icc_nex_fixed(I=12, CV=1.25, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=2)

write.csv(icc_table_12_3, file = paste0("./icc_table_nex_12_3_naive.csv"))


icc_table_96_1 <- icc_nex_fixed(I=96, CV=0.25, t=5, cmean=100, delta=log(0.35),
                                base=0.3, end=0.3, type=2)

write.csv(icc_table_96_1, file = paste0("./icc_table_nex_96_1_naive.csv"))

icc_table_96_2 <- icc_nex_fixed(I=96, CV=0.75, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=2)

write.csv(icc_table_96_2, file = paste0("./icc_table_nex_96_2_naive.csv"))

icc_table_96_3 <- icc_nex_fixed(I=96, CV=1.25, t=5, cmean=100, delta=log(0.35), 
                                base=0.3, end=0.3, type=2)

write.csv(icc_table_96_3, file = paste0("./icc_table_nex_96_3_naive.csv"))
